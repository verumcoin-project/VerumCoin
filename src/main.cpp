...
const string strMessageMagic = "VerumCoin Signed Message:\n";
...
{    
	if (nHeight == 1) return 390000000 * COIN;
    if (nHeight > 1 && nHeight <= 61) return 20000000 * COIN;
    ...
    // VerumCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("VerumCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in VerumCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // VerumCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VerumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "https://bitcointalk.org/index.php?topic=1861559.0";
        unsigned int nTimeGenesis = 1492602449;
        unsigned int nNonceGenesis = 280815;

        if (fTestNet)
        {
            pszTimestamp ="https://bitcointalk.org/index.php?topic=1861559.0";
            nTimeGenesis = 1492602449;
            nNonceGenesis = 17822;
        }
        ...
        if (!fTestNet)
            assert(block.hashMerkleRoot == uint256("0x056f286c421503194ed49484dafbaf1b41f409c9e284de48ef7cd8e44514786b"));
        else
            assert(block.hashMerkleRoot == uint256("0x056f286c421503194ed49484dafbaf1b41f409c9e284de48ef7cd8e44514786b"));
...
unsigned char pchMessageStart[4] = { 0xe3, 0xd2, 0xfe, 0xac };
