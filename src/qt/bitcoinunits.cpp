...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("VerumCoins"));
    case mBTC: return QString(QObject::tr("Milli-VerumCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-VerumCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
